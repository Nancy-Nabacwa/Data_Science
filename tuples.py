...
names = 'Gatweri','Gitahi','Wanjiku','Katumbi','Ingabire'
...
listnames.insert(0,"wagithomo")
print(listnames)

listnames.extend(['wairomo','gahinomo'])
print(listnames)

for i in listnames:print (i)

if 'Gatweri' in listnames:print('Gatweri is smiling')
